...
var MenuItem2 = /** @class */ (function (_super) {
    ...
    MenuItem2.prototype.render = function () {
        ...
        var anchorClasses = (0, classnames_1.default)(core_1.Classes.MENU_ITEM, intentClass, (_a = {},
            ...
            _a), className);
        var target = React.createElement(tagName, tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ role: targetRole, tabIndex: 0 }, (0, core_1.removeNonHTMLProps)(htmlProps)), (disabled ? DISABLED_PROPS : {})), { className: anchorClasses }), hasIcon ? (
