...
var MenuItem2 = /** @class */ (function (_super) {
    ...
    MenuItem2.prototype.render = function () {
        ...
        var anchorClasses = classNames(CoreClasses.MENU_ITEM, intentClass, (_a = {},
            ...
            _a), className);
        var target = React.createElement(tagName, __assign(__assign(__assign({ role: targetRole, tabIndex: 0 }, removeNonHTMLProps(htmlProps)), (disabled ? DISABLED_PROPS : {})), { className: anchorClasses }), hasIcon ? (
