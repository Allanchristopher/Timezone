...
export declare type Tooltip2Props<TProps = DefaultPopover2TargetHTMLProps> = ITooltip2Props<TProps>;
/** @deprecated use Tooltip2Props */
export interface ITooltip2Props<TProps = DefaultPopover2TargetHTMLProps> extends Omit<Popover2SharedProps<TProps>, "shouldReturnFocusOnClose">, IntentProps {
    /**
