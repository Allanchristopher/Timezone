 ...
 */
export declare type PopperModifierOverrides = Partial<{
 ...
 */
export declare type PopperCustomModifer = Partial<Modifier<any, object>>;
/**
 ...
 */
export declare type DefaultPopover2TargetHTMLProps = React.HTMLProps<HTMLElement>;
/**
